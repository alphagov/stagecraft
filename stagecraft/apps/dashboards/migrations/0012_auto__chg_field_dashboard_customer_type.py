...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dashboard.customer_type'
        db.alter_column(u'dashboards_dashboard', 'customer_type', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Dashboard.customer_type'
        db.alter_column(u'dashboards_dashboard', 'customer_type', self.gf('django.db.models.fields.CharField')(max_length=20))
